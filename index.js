...
exports.getMultiSelectValues = exports.get_event_target = exports.getViewUrl = exports.getViewName = exports.getOrientation = exports.getViewportHeight = exports.getDocWidth = exports.getDocHeight = exports.get_page_coord = exports.add_dom_event = void 0;

function add_dom_event(element, type, listener) {
  if (!element) {
    return;
  }
...
exports.add_dom_event = add_dom_event;
...
exports.cloneObject = exports.getProperties = exports.stripTrailingSlash = exports.hasAnyProperties = exports.getMsTimestamp = exports.getTimestamp = void 0; //get current timestamp
...
exports.hasAnyProperties = hasAnyProperties; //removing trailing slashes
...
function cloneObject(original) {
  var clonedObject = JSON.parse(JSON.stringify(original));
  return clonedObject;
}
...
exports.getMetrics = exports.detected_device = void 0;

var configs_1 = require("../configs");

var logger_1 = require("../logger");

var utils_1 = require("../helpers/utils"); // detect current device


exports.detected_device = detect_device();
...
function getMetrics() {
  var metrics = utils_1.cloneObject(configs_1.Config.metrics || {}); //getting app version
...
},{"../configs":"core/configs.ts","../logger":"core/logger/index.ts","../helpers/utils":"core/helpers/utils.ts"}],"core/reports/reports.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.report_conversion = exports.report_orientation = void 0;
...
exports.report_conversion = report_conversion;
},{"../eventUtils":"core/eventUtils.ts","../consents/consent":"core/consents/consent.ts","../store/store":"core/store/store.ts","../browser/domUtils":"core/browser/domUtils.ts","../queues/queueWrapper":"core/queues/queueWrapper.ts"}],"core/store/userData.ts":[function(require,module,exports) {
"use strict";
/**
...
var queueWrapper_1 = require("../queues/queueWrapper"); //   Cdlx.userData = {
...
function () {
  ...
  UserData.prototype.save = function () {
    if (consent_1.Consent.check_consent("users")) {
      queueWrapper_1.toRequestQueue({
        user_details: {
          custom: utils_1.cloneObject(this.customData)
        }
      });
    }
...
exports.prepareParams = exports.sendXmlHttpRequest = void 0;

var configs_1 = require("../configs");

var logger_1 = require("../logger"); //sending xml HTTP request


function sendXmlHttpRequest(url, params, callback) {
  if (configs_1.Config.postAsRequestBody) {
    return sendAsJsonBody(url, params, callback);
  } else {
    return sendAsFormData(url, params, callback);
  }
}

exports.sendXmlHttpRequest = sendXmlHttpRequest;

function sendAsFormData(url, params, callback) {
  try {
...
function sendAsJsonBody(url, params, callback) {
  try {
    logger_1.Logger.log("Sending XML HTTP request");
    var xhr = window.XMLHttpRequest ? new window.XMLHttpRequest() : window.ActiveXObject ? new window.ActiveXObject("Microsoft.XMLHTTP") : null;
    params = params || {};
    var data = prepareJsonBody(params);
    xhr.open("POST", url, true);
...
function prepareJsonBody(params) {
  ...
  for (p in obj) {
    if (obj.hasOwnProperty(p)) {
      var k = prefix ? prefix + "[" + p + "]" : p,
          v = obj[p];
      str.push(v !== null && _typeof(v) === "object" ? serializeNestedObject(v, k) : encodeURIComponent(k) + "=" + encodeURIComponent(v));
    }
  }
...
function prepareParams(params) {
  ...
  for (var i in params) {
    if (params[i] !== null && _typeof(params[i]) === "object") {
...
},{"../configs":"core/configs.ts","../logger":"core/logger/index.ts"}],"core/queues/timedEvents.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.TimedEvents = void 0;
...
var TimedEventsEntity =
/** @class */
function () {
  function TimedEventsEntity() {
    this.timedEvents = {};
  }

  TimedEventsEntity.prototype.setTimedEvents = function (request) {
    this.timedEvents = request;
  };
  /**
  ...
  TimedEventsEntity.prototype.start_event = function (key) {
    if (this.timedEvents[key]) {
      logger_1.Logger.log("Timed event with key " + key + " already started");
      return;
    }

    this.timedEvents[key] = utils_1.getTimestamp();
  };
  /**
   * End timed event
  ...
  TimedEventsEntity.prototype.end_event = function (event) {
    ...
    event.dur = utils_1.getTimestamp() - this.timedEvents[event.key];
    eventUtils_1.push_events(event);
    delete this.timedEvents[event.key];
  };

  return TimedEventsEntity;
}();

var timedEvents = new TimedEventsEntity();
exports.TimedEvents = timedEvents;
},{"../eventUtils":"core/eventUtils.ts","../helpers/utils":"core/helpers/utils.ts","../logger":"core/logger/index.ts"}],"core/fetchRemoteConfig.ts":[function(require,module,exports) {
"use strict";
...
var httpHelpers_1 = require("./helpers/httpHelpers");
...
function fetch_remote_config(keys, omit_keys, callback) {
  if (consent_1.Consent.check_any_consent()) {
    ...
    if (consent_1.Consent.check_consent("sessions")) {
      request_1.metrics = utils_1.cloneObject(browserUtls_1.getMetrics());
    }
    ...
    if (keys) {
      if (!callback && typeof keys === "function") {
        ...
        request_1.keys = utils_1.cloneObject(keys);
      }
    }
    ...
    if (omit_keys) {
      if (!callback && typeof omit_keys === "function") {
        ...
        request_1.omit_keys = utils_1.cloneObject(omit_keys);
      }
    }

    requestBuilder_1.prepareRequest(request_1);
    httpHelpers_1.sendXmlHttpRequest(configs_2.Config.url + configs_1.DefaultConfig.readPath, request_1, function (err, params, responseText) {
      try {
        var configs = JSON.parse(responseText);

        if (request_1.keys || request_1.omit_keys) {
          //we merge config
...
},{"./consents/consent":"core/consents/consent.ts","./browser/browserUtls":"core/browser/browserUtls.ts","./requestBuilder":"core/requestBuilder.ts","./helpers/httpHelpers":"core/helpers/httpHelpers.ts","./configs":"core/configs.ts","./configWrapper":"core/configWrapper.ts","./store/store":"core/store/store.ts","./helpers/utils":"core/helpers/utils.ts"}],"core/helpers/misc.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.notifyLoaders = exports.checkVistorIgnore = exports.checkUrlDataForHeatmapAndToken = exports.change_id = void 0;
...
var timedEvents_1 = require("../queues/timedEvents");

var sessionUtils_1 = require("../sessionUtils");

var fetchRemoteConfig_1 = require("../fetchRemoteConfig");
...
function change_id(newId, merge) {
  if (configs_1.Config.device_id !== newId) {
    if (!merge) {
      //empty event queue
      if (queueWrapper_1.eventQueue.length > 0) {
        // toRequestQueue({ events: JSON.stringify(eventQueue) });
        queueWrapper_1.toRequestQueue({
          events: utils_1.cloneObject(queueWrapper_1.eventQueue)
        }); // eventQueue = [];

        queueWrapper_1.setEventQueue([]);
        store_1.store("event_queue_data", queueWrapper_1.eventQueue);
      } //end current session


      sessionUtils_1.Session.end_session(null, true); //clear timed events
      //   timedEvents = {};

      timedEvents_1.TimedEvents.setTimedEvents({});
    }

    var oldId = configs_1.Config.device_id;
    configs_1.Config.device_id = newId;
    store_1.store("cly_id", configs_1.Config.device_id);
    logger_1.Logger.log("Changing id");
    ...
    if (configs_1.Config.remote_config) {
      // remoteConfigs = {};
      configWrapper_1.setRemoteConfigs({});
      store_1.store("cly_remote_configs", configs_1.Config.remoteConfigs);
      fetchRemoteConfig_1.fetch_remote_config(configs_1.Config.remote_config);
    }
  }
}

exports.change_id = change_id;

function checkUrlDataForHeatmapAndToken() {
  ...
  if (passed_data) {
    if (passed_data.token && passed_data.purpose) {
      ...
      if (passed_data.purpose === "heatmap") {
        configs_1.Config.ignore_visitor = true; // loadHeatMap(); //Removed heatmap functionality
      }
    }
  }
}

exports.checkUrlDataForHeatmapAndToken = checkUrlDataForHeatmapAndToken;
/**
 *  checking whether to ignore the visitor or not.
 **/

function checkVistorIgnore() {
...
},{"../queues/queueWrapper":"core/queues/queueWrapper.ts","../store/store":"core/store/store.ts","../configs":"core/configs.ts","../logger":"core/logger/index.ts","../../globalContext":"globalContext.ts","../configWrapper":"core/configWrapper.ts","../queues/timedEvents":"core/queues/timedEvents.ts","../sessionUtils":"core/sessionUtils.ts","../fetchRemoteConfig":"core/fetchRemoteConfig.ts","../consents/consent":"core/consents/consent.ts","../../cdlxContext":"cdlxContext.ts","./utils":"core/helpers/utils.ts"}],"trackers/heartBeat.ts":[function(require,module,exports) {
"use strict";
...
var queueWrapper_1 = require("../core/queues/queueWrapper");
...
var httpHelpers_1 = require("../core/helpers/httpHelpers");

var misc_1 = require("../core/helpers/misc"); //heart beat
...
function () {
  ...
  HeartBeat.prototype.handleEventQueueSnapshot = function (asyncQueueSnapshot) {
    for (var i = 0; i < asyncQueueSnapshot.length; i++) {
      var eventToProcess = asyncQueueSnapshot[i];
      logger_1.Logger.log("Processing queued call", eventToProcess);

      if (typeof eventToProcess === "function") {
        eventToProcess();
      } else if (Array.isArray(eventToProcess) && eventToProcess.length > 0) {
        // TODO: improve this to handle all possible kinds of data/structures.
        // Assumption: Array of items will be passed like [eventName, eventData1, eventData2]
        var eventName = eventToProcess[0];
        var eventData = eventToProcess.slice(1);

        if (typeof cdlxContext_1.Cdlx[eventName] !== "undefined") {
          cdlxContext_1.Cdlx[eventName].apply(null, eventData);
        } else {
          // Handling the data push for ["userData.EmailAddress", "xyzabc@gmail.com"]
          var userdata = eventName.replace("userData.", "");

          if (typeof userData_1.UserData[userdata] !== "undefined") {
            userData_1.UserData[userdata].apply(null, eventData);
          }
        }
      } else {
        logger_1.Logger.log("Unable to process queued call, please send the data in correct format!", eventToProcess);
      }
    }
  };
  ...
  HeartBeat.prototype.extendSessionIfNeeded = function () {
    if (sessionUtils_1.Session.sessionStarted && configs_1.DefaultConfig.autoExtend && sessionUtils_1.Session.trackTime) {
      ...
      if (last - this.lastBeat > configs_1.DefaultConfig.sessionUpdate) {
        sessionUtils_1.Session.session_duration(last - this.lastBeat);
        this.lastBeat = last;
      }
    }
  };

  HeartBeat.prototype.setLastBeat = function () {
    this.lastBeat = utils_1.getTimestamp();
  };

  HeartBeat.prototype.getLastBeat = function () {
    return this.lastBeat;
  }; //process event queue


  HeartBeat.prototype.processEventQueue = function () {
    if (queueWrapper_1.eventQueue.length > 0) {
      //TODO: We can add minEventBatch and maxWaitTimeForBatch
      if (queueWrapper_1.eventQueue.length <= configs_1.Config.maxEventBatch) {
        queueWrapper_1.toRequestQueue({
          events: utils_1.cloneObject(queueWrapper_1.eventQueue)
        }); // eventQueue = [];
        ...
        var events = queueWrapper_1.eventQueue.splice(0, configs_1.Config.maxEventBatch);
        queueWrapper_1.toRequestQueue({
          events: utils_1.cloneObject(events)
        });
      }
    ...
    if (!configWrapper_1.isOfflineMode() && queueWrapper_1.requestQueue.length > 0 && this.readyToProcess && utils_1.getTimestamp() > this.failTimeout) {
      ...
      httpHelpers_1.sendXmlHttpRequest(configs_1.Config.url + configs_1.DefaultConfig.apiPath, params, function (err, params) {
        ...
        if (err) {
          ...
          queueWrapper_1.requestQueue.shift();
        }
...
},{"../cdlxContext":"cdlxContext.ts","../core/helpers/utils":"core/helpers/utils.ts","../core/queues/queueWrapper":"core/queues/queueWrapper.ts","../core/store/store":"core/store/store.ts","../core/configs":"core/configs.ts","../core/logger":"core/logger/index.ts","../core/sessionUtils":"core/sessionUtils.ts","../core/store/userData":"core/store/userData.ts","../core/configWrapper":"core/configWrapper.ts","../core/consents/consent":"core/consents/consent.ts","../core/helpers/httpHelpers":"core/helpers/httpHelpers.ts","../core/helpers/misc":"core/helpers/misc.ts"}],"core/sessionUtils.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  SessionEntity.prototype.begin_session = function (noHeartBeat, force) {
    if (consent_1.Consent.check_consent("sessions")) {
      if (!this.sessionStarted) {
        //report orientation
        reports_1.report_orientation();
        domUtils_1.add_dom_event(window, "resize", function () {
          reports_1.report_orientation();
        }); // HeartBeat.lastBeat = getTimestamp();

        heartBeat_1.HeartBeat.setLastBeat();
        this.sessionStarted = true; // GlobalContext.setSessionStarted(true);
        ...
        if (force || !this.useSessionCookie || !expire || parseInt(expire) <= utils_1.getTimestamp()) {
          ...
          var req = {};
          req.begin_session = 1;
          req.metrics = browserUtls_1.getMetrics();
          queueWrapper_1.toRequestQueue(req);
        }
  ...
  SessionEntity.prototype.session_duration = function (sec) {
    if (consent_1.Consent.check_consent("sessions")) {
      if (this.sessionStarted) {
  ...
  SessionEntity.prototype.end_session = function (sec, force) {
    if (consent_1.Consent.check_consent("sessions")) {
      if (this.sessionStarted) {
        ...
        this.sessionStarted = false; // GlobalContext.setSessionStarted(false);
      }
    }
  };

  SessionEntity.prototype.reportViewDuration = function () {
    if (this.lastView) {
      var segments = {
        name: this.lastView
      }; //track pageview
      ...
      if (consent_1.Consent.check_consent("views")) {
        eventUtils_1.push_events({
          key: "[CLY]_view",
          dur: this.trackTime ? utils_1.getTimestamp() - this.lastViewTime : this.lastViewStoredDuration,
  ...
  SessionEntity.prototype.stop_time = function () {
    if (this.trackTime) {
      this.trackTime = false;
      this.storedDuration = utils_1.getTimestamp() - heartBeat_1.HeartBeat.getLastBeat();
  ...
  SessionEntity.prototype.start_time = function () {
    if (!this.trackTime) {
      this.trackTime = true;
      heartBeat_1.HeartBeat.lastBeat = utils_1.getTimestamp() - this.storedDuration;
...
},{"./consents/consent":"core/consents/consent.ts","./browser/domUtils":"core/browser/domUtils.ts","./logger":"core/logger/index.ts","../globalContext":"globalContext.ts","./queues/queueWrapper":"core/queues/queueWrapper.ts","./eventUtils":"core/eventUtils.ts","./helpers/utils":"core/helpers/utils.ts","./browser/browserUtls":"core/browser/browserUtls.ts","./store/store":"core/store/store.ts","./reports/reports":"core/reports/reports.ts","./configs":"core/configs.ts","../trackers/heartBeat":"trackers/heartBeat.ts"}],"core/consents/consent.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Consents.prototype.updateConsent = function () {
    ...
    this.consentTimer = setTimeout(function () {
      if (utils_1.hasAnyProperties(_this.syncConsents)) {
        ...
        queueWrapper_1.toRequestQueue({
          consent: utils_1.cloneObject(_this.syncConsents)
  ...
  Consents.prototype.checkIfAnyConsentToSync = function () {
    ...
    var params = queueWrapper_1.getRequestQueue()[0];
    ...
    if (utils_1.hasAnyProperties(this.syncConsents)) {
      ...
      params.consent = utils_1.cloneObject(this.syncConsents);
      this.syncConsents = {};
    }
  };
  ...
  Logger.prototype.recordError = function (err, nonfatal, segments) {
    if (consent_1.Consent.check_consent("crashes") && err) {
      ...
      var ob = {
        ...
        _run: utils_1.getTimestamp() - this.startTime
      };
...
},{"../configs":"core/configs.ts","../consents/consent":"core/consents/consent.ts","../queues/queueWrapper":"core/queues/queueWrapper.ts","../browser/browserUtls":"core/browser/browserUtls.ts","../helpers/utils":"core/helpers/utils.ts","../browser/domUtils":"core/browser/domUtils.ts"}],"trackers/trackPageView.ts":[function(require,module,exports) {
"use strict";
...
function track_pageview(page, ignoreList, viewSegments) {
  sessionUtils_1.Session.reportViewDuration(); //we got ignoreList first
  ...
  sessionUtils_1.Session.lastView = page;
  sessionUtils_1.Session.lastViewTime = utils_1.getTimestamp();
  var segments = {
    name: page,
    visit: 1,
...
},{"../core/browser/domUtils":"core/browser/domUtils.ts","../core/logger":"core/logger/index.ts","../core/configs":"core/configs.ts","../core/sessionUtils":"core/sessionUtils.ts","../globalContext":"globalContext.ts","../core/helpers/utils":"core/helpers/utils.ts","../core/eventUtils":"core/eventUtils.ts","../core/consents/consent":"core/consents/consent.ts"}],"trackers/utmTagTracker.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.captureUtmTags = void 0;
...
function captureUtmTags() {
  ...
  if (location.search) {
    ...
    for (i = 0; i < parts.length; i++) {
      ...
      if (key === "cly_id") {
        store_1.store("cly_cmp_id", value);
      } else if (key === "cly_uid") {
        store_1.store("cly_cmp_uid", value);
      } else if (key === "cly_device_id") {
        configs_1.Config.device_id = value;
      } else if ((key + "").indexOf("utm_") === 0 && cdlxContext_1.Cdlx.utm[key.replace("utm_", "")]) {
        utms[key.replace("utm_", "")] = value;
        hasUTM = true;
      }
    }
...
exports.captureUtmTags = captureUtmTags;
},{"../cdlxContext":"cdlxContext.ts","../core/configs":"core/configs.ts","../core/store/store":"core/store/store.ts","../core/store/userData":"core/store/userData.ts"}],"core/helpers/polyfillsAsPrototype.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createPolyfills = void 0;
...
var utmTagTracker_1 = require("./trackers/utmTagTracker");

var misc_1 = require("./core/helpers/misc");
...
},{"process":"../node_modules/process/browser.js"}],"trackers/tags/tagsConfig.json":[function(require,module,exports) {
module.exports = [{
...
},{}],"trackers/tags/tagsTracker.ts":[function(require,module,exports) {
"use strict";
...
var tagsConfig_json_1 = __importDefault(require("./tagsConfig.json"));

function configure_track_click_events() {
  var configurations = tagsConfig_json_1.default;
  var elements = [];
  ...
  var _loop_1 = function _loop_1(index) {
    ...
    if (!!configurationItem.eventSelector) {
      ...
      if (configurationItem.eventTrigger == "byClassName") {
        var elementsByClassName = document.getElementsByClassName(configurationItem.eventElement);

        for (var _i = 0, elementsByClassName_1 = elementsByClassName; _i < elementsByClassName_1.length; _i++) {
          var element = elementsByClassName_1[_i];
          elements.push({
            element: element,
            configuration: configurationItem
          });
  ...
  var _loop_2 = function _loop_2(element) {
    ...
    domUtils_1.add_dom_event(element.element, "click", function (event) {
...
if (window.Cdlx) {
  window.Cdlx = CdlxContext.clone(window.Cdlx);
...
Object.defineProperty(exports, "Cdlx", {
  enumerable: true,
  get: function get() {
    return cdlxContext_1.Cdlx;
  }
});
